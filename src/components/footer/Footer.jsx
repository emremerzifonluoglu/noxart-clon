    ...
    <div className="footer">
      <Container maxWidth="xl">
          ...
          <div className="left">
            ...
            <div className="media">
              <a
                rel="noreferrer"
                class="m-a"
                href="https://tr.linkedin.com/company/noxartgames"
              >
                <svg
                  color="#bbb"
                  stroke="currentColor"
              ...
              <a
                rel="noreferrer"
                class="m-a"
                href="https://twitter.com/noxartgames"
              >
                <svg
                  color="#bbb"
                  stroke="currentColor"
              ...
              <a
                rel="noreferrer"
                class="m-a"
                href="https://www.facebook.com/NoxartGames"
              >
                <svg
                  color="#bbb"
                  stroke="currentColor"
              ...
              <a
                rel="noreferrer"
                class="m-a"
                href="https://www.instagram.com/noxartgames/"
              >
                <svg
                  color="#bbb"
                  stroke="currentColor"
        ...
        <div className="company">
          <p class="c-p">Copyright@ Noxart Bilişim San. Ve Tic. A.Ş.</p>
        </div>
      </Container>
    </div>
  );
